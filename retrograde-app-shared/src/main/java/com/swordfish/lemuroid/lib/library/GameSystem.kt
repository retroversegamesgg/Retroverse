        ...
        private val SYSTEMS =
            listOf(
                    ...
                    listOf(
                        SystemCoreConfig(
                            ...
                            controllerConfigs = hashMapOf(
                                ...
                                1 to arrayListOf(ControllerConfigs.NINTENDO_3DS),
                                2 to arrayListOf(ControllerConfigs.NINTENDO_3DS),
                                3 to arrayListOf(ControllerConfigs.NINTENDO_3DS),
                            ),
                            rumbleSupported = true,
                            statesSupported = false, // Dolphin geralmente não suporta save states bem no libretro
                            supportsLibretroVFS = true,
                            supportedOnlyArchitectures = setOf("arm64-v8a", "x86_64"), // Dolphin é pesado
                        ),
                    ),
                    uniqueExtensions = listOf("gcm", "iso", "gcz"),
                    supportedExtensions = listOf("gcm", "iso", "gcz", "ciso", "wbfs", "rvz"),
                ...
                GameSystem(
                    ...
                    R.string.game_system_abbr_gcn,
                    listOf(
                        SystemCoreConfig(
                            CoreID.DOLPHIN,
                            controllerConfigs = hashMapOf(
                                0 to arrayListOf(ControllerConfigs.NINTENDO_3DS), // mudar depois
                                1 to arrayListOf(ControllerConfigs.NINTENDO_3DS),
                                2 to arrayListOf(ControllerConfigs.NINTENDO_3DS),
                                3 to arrayListOf(ControllerConfigs.NINTENDO_3DS),
                            ),
                            ...
                            defaultSettings = listOf(
                                CoreVariable("dolphin_cpu_core", "JITARM64"),
                                CoreVariable("dolphin_renderer", "Hardware"),
                                CoreVariable("dolphin_efb_scale", "640x528"),
                                CoreVariable("dolphin_fastmem", "enabled"),
                                CoreVariable("dolphin_dsp_hle", "enabled")
                                ),
                            // ========================
                        ),
                    ),
